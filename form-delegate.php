...
if(isset($_SESSION['verify'])) die("<h1>You have already submitted a form.</h1><p>Please contact Aryan Pingle for further assistance</p>");
...
$addr = 'tech.ismun2019@gmail.com'; // Shouldn't go here at all

if($p1 == 'AIPPM') $addr='aippm.ismun2019@gmail.com';
else if($p1 == 'DISEC') $addr='disec.ismun2019@gmail.com';
else if($p1 == 'ECOSOC') $addr='ecosoc.ismun2019@gmail.com';
else if($p1 == 'FSC') $addr='fsc.ismun2019@gmail.com';
else if($p1 == 'UNEP') $addr='unep.ismun2019@gmail.com';
else if($p1 == 'UNGA') $addr='unga.ismun2019@gmail.com';
else if($p1 == 'UNHCR') $addr='unhcr.ismun2019@gmail.com';
else if($p1 == 'UNODC') $addr='unodc.ismun2019@gmail.com';
else if($p1 == 'UNSC') $addr='unsc.ismun2019@gmail.com';
else if($p1 == 'WHO') $addr='who.ismun2019@gmail.com';
else $addr = 'secretariat.ismun2019@gmail.com';

// Increase counters
$handle = fopen("counter-delegate.txt", "r");
$counter = (int) fread($handle,20);
fclose ($handle);
$counter++ ;
$handle = fopen("counter-delegate.txt", "w" );
...
//email_body is the file containing the template shown in 'email_eb.html' sent to the eb after form submission
$email_body =file_get_contents("email_eb.html");
...
$email_body = str_replace("#school", $_POST['school'], $email_body);
$email_body = str_replace("#about", $_POST['about-self'], $email_body);
$email_body = str_replace("#fp", $_POST['com1'], $email_body);
$email_body = str_replace("#sp", $_POST['com2'], $email_body);
$email_body = str_replace("#tp", $_POST['com3'], $email_body);
$email_body = str_replace("#why", $_POST['perfect'], $email_body);
$email_body = str_replace("#ip", $_SERVER['REMOTE_ADDR'] , $email_body);
$email_body = str_replace("#uid", $uid, $email_body);
$email_body = str_replace("#weak", $_POST['weak'], $email_body);
$email_body = str_replace("#food", $_POST['food'], $email_body);
$email_body = str_replace("#codelegate", $_POST['codelegate'], $email_body);
...
<body class="landing">
	<div id="page-wrapper">
		...
		<section class="main wrapper style1 cominfo">
			<div class="content">
				<div class="container">
					<div class="row">
						<div class="col-12">
