...
$addr = 'press.ismun2019@gmail.com';

// Increase counters
$handle = fopen("counter-press.txt", "r");
$counter = (int) fread($handle,20);
fclose ($handle);
$counter++ ;
$handle = fopen("counter-press.txt", "w" );
...
//email_body is the file containing the template shown in 'email_eb.html' sent to the press after form submission
$email_body =file_get_contents("email_press.html");
...
$email_body = str_replace("#notre-dame", $_POST['notre-dame'], $email_body);
