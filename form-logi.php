...
$addr = 'logistics.ismun2019@gmail.com';

// Increase counters
$handle = fopen("counter-logi.txt", "r");
$counter = (int) fread($handle,20);
fclose ($handle);
$counter++ ;
$handle = fopen("counter-logi.txt", "w" );
...
//email_body is the file containing the template shown in 'email_eb.html' sent to the logi after form submission
$email_body =file_get_contents("email_logi.html");
...
$email_body = str_replace("#shirt", $_POST['shirt'], $email_body);
