...
function everySecond(){
 if(secq) {
  if(sec==null) {
   ...
   startDate = new Date(2019, 6, 26, 9, 0);
   endDate = new Date(2019, 6, 28, 15, 0);
  }
  ...
  if(time/1000 <= 0) {
   ...
   tt.innerHTML = 'ISMUN 2019 has commenced. Wishing all the best to every delegate!';
  }
  else
  {
 ...
 else if(!changed && endDate-new Date() < 0)
 {
  ...
  tt.innerHTML = "28th July, 2019<br><br>Dear delegate,<br><br>If you're reading this, it can only mean one thing. ISMUN 2019 has concluded. Seriously, it's not like a motion to suspend formal debate (which y'all evidently love). This is the real thing.<br><br>We're sure you must be feeling a lot of emotions right now - you probably have a smile on your face, remembering the great moments you shared with your friends. You might have won an award, and are really excited. Or maybe you didn't. That's alright.<br>If you have come out of this event a better person, you have already won.<br><br>Do not cry because it's over; smile because it happened.<br><br>Alright, time to make this extra sappy. An enormous thank you to all our marketing heads for scoring such amazing sponsors. To the members of the Logistics Team, thank you so much for reading all our delegates' chits and relaying the juicy gossip to us. And to all the unsung heroes who worked tirelessly to make this edition of ISMUN the best it could be, your contribution is priceless.<br><br>Are we done? Did we get everybody? Good. Well, peace out. We hope to see you again next year.<br><br>Oh, and may the decorum be with you.<br><br>Our regards,<br>The ISMUN Team.";
  changed = true;
 }
}